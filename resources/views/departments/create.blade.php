...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-surface-white rounded-lg border border-border-light overflow-hidden">
        <div class="px-6 py-4 border-b border-border-light">
            <h2 class="font-display text-lg font-semibold text-on-surface">Departemen Baru</h2>
            <p class="text-sm text-on-surface-variant mt-0.5">Isi data departemen yang akan ditambahkan.</p>
        </div>
        ...
        <form method="POST" action="{{ route('departments.store') }}" class="p-6 space-y-5">
            ...
            <div>
                ...
                <input type="text" id="code" name="code" value="{{ old('code') }}" required
                       placeholder="Contoh: HE, WBIC, PKA"
