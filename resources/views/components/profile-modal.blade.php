        ...
        <div class="p-6 sm:p-7">
            ...
            <div class="flex items-center justify-between pb-4 border-b border-border-light">
                ...
                <button type="button" 
                        ...
                        class="p-1.5 rounded-lg text-on-surface-variant hover:text-on-surface hover:bg-surface-container transition-colors cursor-pointer"
            ...
            <div class="mt-6">
                ...
                <form method="POST" action="{{ route('profile.password.update') }}" class="space-y-4" id="formChangePassword">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <button type="button" 
                                    ...
                                    class="absolute inset-y-0 right-0 pr-3 flex items-center text-on-surface-variant hover:text-on-surface transition-colors cursor-pointer"
                                    tabindex="-1">
                    ...
                    <div class="pt-3 flex items-center justify-end gap-2.5 border-t border-border-light mt-5">
                        <button type="button" 
                                onclick="closeProfileModal()" 
                                class="px-4 py-2 text-xs font-semibold text-on-surface-variant hover:text-on-surface bg-surface-container hover:bg-surface-container-high rounded-md transition-colors cursor-pointer">
                            Tutup
                        </button>
                        <button type="submit" 
